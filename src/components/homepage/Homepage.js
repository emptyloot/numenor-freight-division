...
function Homepage() {
    ...
    return (
        <main className="container mx-auto p-4 text-center text-[#EDF2F4]">
            <div>
              {/*Inspiring message */}
              <h1 className="text 4x1 md:text-5x1 font-bold mt-8">
                "By land or sea, the world turns on our trade"
                </h1>
                {/*Calculator */}
                ...
                <form className="space-y-4">
                    <div>
                        <label htmlFor="tp-energy" className="block text-left mb-1">Enter TP Energy:</label>
                        <input id="tp-energy" type="number" min='0' value={energy} onChange={(e) => setEnergy(e.target.value)} className="w-full p-3 rounded-lg bg-white/90 text-black placeholder-gray-500"/>
                    </div>
                    <div>
                        <label htmlFor="number-tiles"  className="block text-left mb-1">Enter Number of Tiles:</label>
                        <input id="number-tiles" typ='number' min='0' value={tiles} onChange={(e) => setTiles(e.target.value)} className="w-full p-3 rounded-lg bg-white/90 text-black placeholder-gray-500"/>
                    </div>
                    <div className="pt-4">
